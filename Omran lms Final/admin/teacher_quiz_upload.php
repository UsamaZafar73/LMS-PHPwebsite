...
if(!isset($_SESSION['user_role'])){ header("Location: ../website/login.php");   }
    if(isset($_SESSION['user_role'])){
        if($_SESSION['user_role']!=='lecturer'){    header("Location: ../website/index.php");   }
    }
?>
    <?php   include "../website/includes/header.php";
        ...
        <div class="main">
            <div class="container">
                <h1>Welcome Teacher --> You can upload Quiz or Assignments Here <sub style="color:gray;"> <?php echo $_SESSION['fullname'] ?> </sub></h1>
                <div class="addEvent">
                    <?php
